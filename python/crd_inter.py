...
for i in xrange(len(pure_reac_crd)):
    x = pure_prod_crd[i][0] * lamada + pure_reac_crd[i][0] * (1-lamada)
    y = pure_prod_crd[i][1] * lamada + pure_reac_crd[i][1] * (1-lamada)
    z = pure_prod_crd[i][2] * lamada + pure_reac_crd[i][2] * (1-lamada)
    xyz = (x, y, z)
